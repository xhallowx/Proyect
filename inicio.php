  ...
  <body>
    ...
    <section class="about">
      <div class="about-content">
        <p class="parfum-button">
          Alguna de Nuestras <br />
          Referencias
        </p>
      </div>
    </section>
    <section class="brands">
      <div class="brands-content">
        <div class="brands-logos">
          <img src="assets/images/ck.gif"  />
          <img src="assets/images/jp.png" />
          <img src="assets/images/lv.png"  />
          <img src="assets/images/dg.png"/>
    ...
    <div class="contact-content">
      ...
      <div class="contact-icons">
        <a href="https://wa.me/tu-numero" target="_blank" class="icon whatsapp"><svg xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 455 510">
            <path
